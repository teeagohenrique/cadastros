...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input id="pesquisar" type="search" class="'+classes.sFilterInput+'"/>';
	...
	function _fnLog( settings, level, msg, tn )
	{
		...
		if ( ! level  ) {
			...
			if ( type == 'alert' ) {
				//alert( msg );
				$(".blocoCentral").html('<div style="border:0px solid red;background:darkred;color:white;padding:5px;margin-top:10px;margin-bottom:10px;font-size:12px;">Tempo de resposta com o servidor esgotou! <br>Tente realizar o processo novamente ou entre em contato com o administrador do sistema.</div><a href="'+base_url+'pagina-inicial" class="btn btn-lg btn-primary" type="submit" style="padding:10px 40px;margin-top:19px;">Pagina Inicial</a><br><br><br><br>');
			}
			else if ( type == 'throw' ) {
				throw new Error(msg);
			}
